...
<form method="post" enctype="multipart/form-data" id="addFormSetting<?php echo ($uniqid); ?>">
 <table class="infobox" width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="23%"><label for="vals">参数值</label><?php if($info['types']=='select' || $info['types']=='more'){ ?>&nbsp;<a href="#"><img id="editOpt" src="__ITEM__/__ADMIN.IMG__/gif_45_081.gif" width="16" height="16" title="编辑选项" /></a><?php } ?></td>
    ...
    删除原图<?php } ?><input name="oopts" type="hidden" value="" /><input name="otypes" type="hidden" value="" /></td>
  </tr>
  <tr>
